		...
		<section className="font-poppins w-11/12 mx-auto my-28">
			<div className="flex flex-col items-center relative">
				...
				<div className="flex gap-3 md:gap-5 absolute top-12 md:top-20 lg:top-28 md:left-0 lg:left-32">
					...
					{/* line */}
					<img
						src="https://assets-global.website-files.com/64fad25f8884cb2d680a1052/64fb2c3711b75356c1845273_Yellow%20Arrow.svg"
						alt=""
			...
			<div className="mt-40 md:mt-80 flex flex-col md:flex-row gap-5 justify-center items-center w-full mx-auto">
				<div className="w-4/5">
					<div className="relative">
						{/* tape */}
						<img
							src="https://assets-global.website-files.com/64fad25f8884cb2d680a1052/64fb2fe0de937671b43ba096_tape.svg"
							alt=""
							className="rotate-6 w-36 absolute left-1/3 md:left-10 lg:left-1/3 -top-6"
						/>
						<img
							src="https://assets-global.website-files.com/64fad25f8884cb2d680a1052/64fb309611b75356c1882c72_Frame%20427320702.webp"
							alt=""
