...
const ClientResults = () => {
	...
	return (
		<section
			ref={svgRef}
			className="bg-clientBg w-11/12 mx-auto font-poppins relative px-8 lg:px-12 pt-28 pb-14 rounded-[30px] lg:rounded-[70px] space-y-0"
		>
			...
			<motion.img
				...
				src={arrow}
				alt=""
				className="absolute top-14 md:top-12 lg:top-10 left-64 md:left-[270px] lg:left-[36%] w-32 md:w-36 lg:w-44"
			/>
			<div className="bg-white p-10 lg:p-16 rounded-3xl md:rounded-[30px] lg:rounded-[40px]">
				...
				>
					...
					{/* link arrow */}
					<a href="">
						<img src={linkArrow} alt="" className="w-8" />
					</a>
					<motion.div
